...
class kittiDataset():
    def __init__(self, path, split, category_name="Car", **kwargs):
        ...
        self.KITTI_image = os.path.join(self.KITTI_Folder, "image_02") # missing folder
    ...
    def _build_tracklet_anno(self):
        ...
        return list_of_tracklet_anno, list_of_tracklet_len  # we have list_of_tracklet_len tracklets
